...
const checkNameExists = "SELECT b FROM breweries b WHERE b.name = $1";
const checkIdExists = "SELECT b FROM breweries b WHERE b.id = $1";
const addBrewery = "INSERT INTO breweries (name, address, city, state, established, website, price_level) VALUES($1, $2, $3, $4, $5, $6, $7)";
